    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "storCd"},
                {key: "storNm"},
                {key: "storeInfoJson.대표자명"},
                {key: "storeInfoJson.사업자등록번호"},
                {key: "storeInfoJson.영업시작시간"},
                {key: "storeInfoJson.영업종료시간"},
                {key: "storeInfoJson.담당자"},
                {key: "storeInfoJson.연락처"}
            ],
            body: {
                onClick: function () {
 ...
 * gridView
 */
fnObj.gridView02 = axboot.viewExtend({
    initView: function () {
        var _this = this;
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "posNo", label: "POS번호"},
                {key: "saleTy", label: "판매형태"},
                {key: "posTy", label: "POS구분"},
                {key: "posSerial", label: "POS시리얼"},
                {key: "useYn"}
            ],
            body: {
                onClick: function () {
