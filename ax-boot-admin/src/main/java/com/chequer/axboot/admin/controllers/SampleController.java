...
import com.chequer.axboot.admin.domain.sample.child.ChildSample;
import com.chequer.axboot.admin.domain.sample.child.ChildSampleService;
import com.chequer.axboot.admin.domain.sample.child.ChildSampleVO;
import com.chequer.axboot.admin.domain.sample.parent.ParentSample;
import com.chequer.axboot.admin.domain.sample.parent.ParentSampleService;
import com.chequer.axboot.admin.domain.sample.parent.ParentSampleVO;
...
public class SampleController extends BaseController {
    ...
    public PageableResponseParams.PageResponse childList(@RequestParam(required = true, defaultValue = "") String parentKey, Pageable pageable) {
        ...
        return PageableResponseParams.PageResponse.of(ChildSampleVO.of(pages.getContent()), pages);
    }
