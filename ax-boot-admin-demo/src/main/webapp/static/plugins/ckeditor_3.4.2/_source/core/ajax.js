...
CKEDITOR.ajax = (function()
{
	...
	return 	/** @lends CKEDITOR.ajax */ {
		 ...
		 * var data = CKEDITOR.AjaxPro.load( 'somedata.txt' );
		 * alert( data );
		 * @example
		 * // Load data asynchronously.
		 * var data = CKEDITOR.AjaxPro.load( 'somedata.txt', function( data )
		 *     {
		 *         alert( data );
		 *     } );
		 */
		 ...
		 * var xml = CKEDITOR.AjaxPro.loadXml( 'somedata.xml' );
		 * alert( xml.getInnerXml( '//' ) );
		 * @example
		 * // Load XML asynchronously.
		 * var data = CKEDITOR.AjaxPro.loadXml( 'somedata.xml', function( xml )
		 *     {
		 *         alert( xml.getInnerXml( '//' ) );
		 *     } );
		 */
