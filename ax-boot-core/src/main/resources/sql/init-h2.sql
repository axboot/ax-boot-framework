;
CREATE USER IF NOT EXISTS SA SALT '0f2c1bf2e4d576ab' HASH 'cf70dde602eaa26711468ff48da69a54a8dcadb24aee66e8ca4b79e08371dbfd' ADMIN;
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_3CA58B2E_41C2_4D31_B989_3266E45130A9 START WITH 10 BELONGS_TO_TABLE;
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_AFD45719_4F3C_4881_A3AF_2BFD567DAFE3 START WITH 453 BELONGS_TO_TABLE;
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_71D86FB0_1DC8_45FB_9277_5B1A9647C31F START WITH 4 BELONGS_TO_TABLE;
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_860A2166_038E_491F_998F_C0A1AED0BDD6 START WITH 7 BELONGS_TO_TABLE;
...
('USER_ROLE', STRINGDECODE('\uc0ac\uc6a9\uc790 \ub864'), 'ASP_ACCESS', STRINGDECODE('ASP \uc811\uadfc \ub864'), 1, NULL, NULL, NULL, NULL, NULL, 'N', NULL, 'Y', TIMESTAMP '2016-09-18 12:20:29.0', 'system', TIMESTAMP '2016-09-18 12:20:29.0', 'system'),
('USER_ROLE', STRINGDECODE('\uc0ac\uc6a9\uc790 \ub864'), 'ASP_MANAGER', STRINGDECODE('ASP \uad00\ub9ac\uc790 \ub864'), 3, NULL, NULL, NULL, NULL, NULL, 'N', NULL, 'Y', TIMESTAMP '2016-09-18 12:20:29.0', 'system', TIMESTAMP '2016-09-18 12:20:29.0', 'system'),
...
CREATE CACHED TABLE PUBLIC.ERROR_LOG_M(
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_AFD45719_4F3C_4881_A3AF_2BFD567DAFE3) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_AFD45719_4F3C_4881_A3AF_2BFD567DAFE3 COMMENT 'ID',
...
CREATE CACHED TABLE PUBLIC.MENU_M(
    MENU_ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_3CA58B2E_41C2_4D31_B989_3266E45130A9) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_3CA58B2E_41C2_4D31_B989_3266E45130A9 COMMENT 'ID',
...
CREATE CACHED TABLE PUBLIC.USER_AUTH_M(
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_71D86FB0_1DC8_45FB_9277_5B1A9647C31F) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_71D86FB0_1DC8_45FB_9277_5B1A9647C31F COMMENT 'ID',
...
('system', STRINGDECODE('\uc2dc\uc2a4\ud15c\uad00\ub9ac\uc790'), '$2a$11$ruVkoieCPghNOA6mtKzWReZ5Ee66hbeqwvlBT1z.W4VMYckBld6uC', NULL, NULL, NULL, TIMESTAMP '2016-09-19 15:52:26.411', TIMESTAMP '2016-01-26 11:50:41.0', 'NORMAL', '0:0:0:0:0:0:0:1', 'ko_KR', 'SYSTEM_MANAGER', 'Y', 'N', TIMESTAMP '2016-09-18 12:20:32.0', 'system', TIMESTAMP '2016-09-19 15:52:26.433', 'system');
CREATE CACHED TABLE PUBLIC.USER_ROLE_M(
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_860A2166_038E_491F_998F_C0A1AED0BDD6) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_860A2166_038E_491F_998F_C0A1AED0BDD6 COMMENT 'ID',
