...
import ${basePackage}.domain.manual.Manual;
import ${basePackage}.domain.manual.ManualListVO;
import ${basePackage}.domain.manual.ManualRequestVO;
import ${basePackage}.domain.manual.ManualService;
