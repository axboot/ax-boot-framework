...
import ${basePackage}.domain.sample.child.ChildSample;
import ${basePackage}.domain.sample.child.ChildSampleService;
import ${basePackage}.domain.sample.child.ChildSampleVO;
import ${basePackage}.domain.sample.parent.ParentSample;
import ${basePackage}.domain.sample.parent.ParentSampleService;
import ${basePackage}.domain.sample.parent.ParentSampleVO;
